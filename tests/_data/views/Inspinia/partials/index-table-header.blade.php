...
<tr class="header-row">
    ...
    <th class="id">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.id'), 'id') !!}
    </th>
    @endif
    @if(in_array('reason_id', $selectedTableColumns))
    <th class="reason_id">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.reason_id'), 'reason_id') !!}
    </th>
    @endif
    @if(in_array('name', $selectedTableColumns))
    <th class="name">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.name'), 'name') !!}
    </th>
    @endif
    @if(in_array('author', $selectedTableColumns))
    <th class="author">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.author'), 'author') !!}
    </th>
    @endif
    @if(in_array('genre', $selectedTableColumns))
    <th class="genre">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.genre'), 'genre') !!}
    </th>
    @endif
    @if(in_array('stars', $selectedTableColumns))
    <th class="stars">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.stars'), 'stars') !!}
    </th>
    @endif
    @if(in_array('published_year', $selectedTableColumns))
    <th class="published_year">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.published_year'), 'published_year') !!}
    </th>
    @endif
    @if(in_array('enabled', $selectedTableColumns))
    <th class="enabled">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.enabled'), 'enabled') !!}
    </th>
    @endif
    @if(in_array('status', $selectedTableColumns))
    <th class="status">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.status'), 'status') !!}
    </th>
    @endif
    @if(in_array('synopsis', $selectedTableColumns))
    <th class="synopsis">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.synopsis'), 'synopsis') !!}
    </th>
    @endif
    @if(in_array('approved_at', $selectedTableColumns))
    <th class="approved_at">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.approved_at'), 'approved_at') !!}
    </th>
    @endif
    @if(in_array('approved_by', $selectedTableColumns))
    <th class="approved_by">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.approved_by'), 'approved_by') !!}
    </th>
    @endif
    @if(in_array('created_at', $selectedTableColumns))
    <th class="created_at">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.created_at'), 'created_at') !!}
    </th>
    @endif
    @if(in_array('updated_at', $selectedTableColumns))
    <th class="updated_at">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.updated_at'), 'updated_at') !!}
    </th>
    @endif
    @if(in_array('deleted_at', $selectedTableColumns))
    <th class="deleted_at">
        {!! UISearch::sortLink('books.index', trans('book.table-columns.deleted_at'), 'deleted_at') !!}
    </th>
    @endif
